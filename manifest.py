...
from capdl.Object import CNode, Endpoint, Frame, TCB, PML4, Untyped, IRQControl
...
tcb_program_1 = TCB("tcb_program_1",ipc_buffer_vaddr= 0x0,ip= 0x0,sp= 0x0,elf= "program_1",prio= 253,max_prio= 253,affinity= 0,init= [])
